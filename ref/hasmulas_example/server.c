	...
	*/
    ...
    {  
        ...
        {  
            ...
            //puts("make the new socket NONBLOCKING");  
		...
		// generate random position for the trophy
		
		trophy = generateTrophy();
		printf("Server: new trophy generated (%2d,%2d)\n", trophy.x, trophy.y);
        ...
        {  
            ...
            {  
                ...
                //incoming message
				//UNDERSTAND THIS PORTION OF THE CODE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                ...
                {  
					...
					printf("Server: Sending coords (%2d,%2d)\n", trophy.x, trophy.y);
					len = sizeof(trophy);
					memcpy(buffer, &trophy, len);
